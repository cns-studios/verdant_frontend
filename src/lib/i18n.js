const translations = {
  en: {
    ...
    "accounts.remove_confirm": "Remove {email}?",
    "accounts.removed": "Account removed",
    "accounts.gmail": "Gmail",
    "accounts.gmail_connected": "Connected {email}",
    "accounts.gmail_connect": "Connect Gmail",
    "accounts.gmail_desc": "Sign in with Google OAuth. A browser window will open.",
    "accounts.imap": "IMAP",
    "accounts.imap_custom": "Custom SMTP",
    "accounts.imap_desc": "Any mail server",
    "accounts.gmx": "GMX",
    "accounts.gmx_desc": "IMAP / SMTP",
    "accounts.test": "Test",
    "accounts.testing": "Testing...",
    "accounts.adding": "Adding...",
    "accounts.cancel": "Cancel",
    "accounts.success": "Connection successful!",
    "accounts.email": "Email Address",
    "accounts.password": "Password",
    "accounts.display_name": "Display Name (optional)",
    "accounts.username_optional": "Username (if different from email)",
    "accounts.username_placeholder": "Leave blank to use email",
    "accounts.server_settings": "Server settings",
    "accounts.imap_host": "IMAP Host",
    "accounts.smtp_host": "SMTP Host",
    "accounts.required": "Email and password are required.",
  },
  ...
  de: {
    ...
    "accounts.remove_confirm": "{email} entfernen?",
    "accounts.removed": "Konto entfernt",
    "accounts.gmail": "Gmail",
    "accounts.gmail_connected": "{email} verbunden",
    "accounts.gmail_connect": "Gmail verbinden",
    "accounts.gmail_desc": "Anmeldung mit Google OAuth. Ein Browserfenster wird geöffnet.",
    "accounts.imap": "IMAP",
    "accounts.imap_custom": "Eigener SMTP",
    "accounts.imap_desc": "Beliebiger Mailserver",
    "accounts.gmx": "GMX",
    "accounts.gmx_desc": "IMAP / SMTP",
    "accounts.test": "Testen",
    "accounts.testing": "Teste...",
    "accounts.adding": "Füge hinzu...",
    "accounts.cancel": "Abbrechen",
    "accounts.success": "Verbindung erfolgreich!",
    "accounts.email": "E-Mail-Adresse",
    "accounts.password": "Passwort",
    "accounts.display_name": "Anzeigename (optional)",
    "accounts.username_optional": "Benutzername (falls anders als E-Mail)",
    "accounts.username_placeholder": "Leer lassen, um E-Mail zu verwenden",
    "accounts.server_settings": "Server-Einstellungen",
    "accounts.imap_host": "IMAP-Host",
    "accounts.smtp_host": "SMTP-Host",
    "accounts.required": "E-Mail und Passwort sind erforderlich.",
  },
};
